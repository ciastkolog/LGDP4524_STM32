...
#define CPLD			29
#define HX8353C			30
#define ILI9327_8		31//OK
#define ILI9220		32//not test yet
#define ST7735S_8	33//8bit
#define R61526_8    34//not test yet
#define HX8352B_8   35//8bit //OK
#define R61580_8    36//8bit
#define RM68130     37//8bit//OK
#define ST7775      37//8bit//OK

#define ILI9225 38//8bit//OK
#define LGDP4525 39//8bit
#define LGDP4524 39//8bit
...
void UTFT(byte model, int RS, int WR, int CS, int RST = 0x40, int SER=0);
